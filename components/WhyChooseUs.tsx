export default function WhyChooseUs() {
  const reasons = [
    ...
    },
    {
      ...
      description: "Extensive coverage across the region ensuring timely delivery to your location.",
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Professional support team ready to assist you with orders, inquiries, and after-sales service.",
    },
  ];
