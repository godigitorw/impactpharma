...
export default function AdminLayout({
  ...
  const navigation = [
    ...
    },
    {
      ...
      href: "/admin/dashboard/contact-details",
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <aside className="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-50">
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-t border-gray-200">
              <Link
                href="/"
                className="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors duration-200 mb-2"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200 w-full"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
