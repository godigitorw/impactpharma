  ...
  return (
    <main>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="mb-6 sm:mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900">Featured Article</h2>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-gradient-to-br from-primary-50 via-blue-50 to-white rounded-lg overflow-hidden border border-primary/20">
            <div className="relative h-[250px] sm:h-[350px] lg:h-auto">
              <Image
            ...
            <div className="p-5 sm:p-6 lg:p-12 flex flex-col justify-center">
              <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 bg-primary text-white text-xs sm:text-sm font-medium rounded-full">
              ...
              <div className="flex items-center gap-2.5 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-primary/10 rounded-full flex items-center justify-center text-primary font-semibold text-sm sm:text-base">
                  {featuredPost.author.charAt(0)}
                </div>
                <span className="text-gray-700 font-medium text-sm sm:text-base">{featuredPost.author}</span>
              </div>
              <Link
                href={`/news/${featuredPost.slug}`}
                className="inline-flex items-center text-primary hover:text-primary-600 font-semibold transition-colors duration-200 text-sm sm:text-base"
              >
                Read Full Article
                <svg
      ...
      {recentPosts.length > 0 && (
        <section className="py-10 sm:py-12 lg:py-16 pb-12 sm:pb-16 lg:pb-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
            <div className="mb-6 sm:mb-8">
              <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900">Recent Articles</h2>
            </div>
                ...
                >
                  ...
                  <div className="p-4 sm:p-5 lg:p-6">
                    <div className="flex items-center gap-2.5 sm:gap-3 mb-2.5 sm:mb-3">
                      <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 bg-primary/10 text-primary text-[10px] sm:text-xs font-medium rounded-full">
                        {post.category}
                      </span>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-primary/10 rounded-full flex items-center justify-center text-primary text-xs sm:text-sm font-semibold shrink-0">
                          {post.author.charAt(0)}
                        </div>
                        <span className="text-xs sm:text-sm text-gray-700 truncate">{post.author}</span>
                      </div>
                      <Link
                        href={`/news/${post.slug}`}
                        className="text-primary hover:text-primary-600 font-medium text-xs sm:text-sm transition-colors duration-200 shrink-0"
                      >
                        Read More →
                      </Link>
                    </div>
