        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Round-the-clock service for your pharmaceutical needs</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">GDP-compliant operations ensuring product integrity</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Serving healthcare facilities across Rwanda</p>
            </div>
          </div>
        </div>
      </section>
