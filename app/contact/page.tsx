          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
              {locations.map((location) => (
                <div
                  key={location.id}
                  className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg border border-gray-200"
                >
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {location.address && (
                      <div className="flex items-start gap-2.5 sm:gap-3">
                        <svg
                          className="w-5 h-5 sm:w-6 sm:h-6 text-primary mt-0.5 shrink-0"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                    ...
                    {location.phone && (
                      <div className="flex items-start gap-2.5 sm:gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-xs sm:text-sm">{location.phone}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {location.email && (
                      <div className="flex items-start gap-2.5 sm:gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-xs sm:text-sm">{location.email}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {location.hours && (
                      <div className="flex items-start gap-2.5 sm:gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-xs sm:text-sm whitespace-pre-line">{location.hours}</p>
                        </div>
                      </div>
                    )}
                  </div>
