            ...
            <div>
                    ...
                    {info.phone && (
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 whitespace-pre-line">{info.phone}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {info.email && (
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 whitespace-pre-line">{info.email}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {info.hours && (
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 whitespace-pre-line">{info.hours}</p>
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all duration-200"
                  >
